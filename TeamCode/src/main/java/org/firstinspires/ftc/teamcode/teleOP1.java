...
// Intake programming start
            ...
            rightElbow.getDirection();
            telemetry.addData("rightwristpos",rightElbow.getPosition());
            telemetry.addData("leftwristpos",leftElbow.getPosition());
